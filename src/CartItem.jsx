...
//       <h2 href="./ProductList.jsx">Shopping Cart</h2>
//       {items.length === 0 ? (
...
//                     <button className="increment-button" onClick={() => handleDecrement(item.name)}>-</button>
//                     <span>{item.quantity}</span>
//                     <button className="decrement-button" onClick={() => handleIncrement(item.name)}>+</button>
//                   </div>
//                 </div>
...
//             </div>
//             <div className="menu">
//                 <a href="#" onClick={goToProductList} style={{ color: 'white', fontSize: '30px', textDecoration: 'none' }}>
//                     <h1 className='cart'>
...
//             <div>
//                 {/* Conținutul pentru pagina CartItem */}
//                 <h1>Cart Page</h1>
//                 {/* Adăugați aici elementele din coș */}
//             </div>
//         </div>
//     );
// };
